...
let IsProvider=()=>JSON.parse(sessionStorage.getItem("roles")).includes("POLICY_PROVIDER");
let IsCustomer=()=>{return JSON.parse(sessionStorage.getItem("roles")).includes("CUSTOMER");}
